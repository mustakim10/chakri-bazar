...
const Details = (props) => {
   ...
   const handleAddApplied = (detail) => {
getShoppingCart(detail.num);
  }
    return (
        <div>
            <section className='grid grid-cols-2 gap-5'>
                ...
                <div className='border p-10'>
                    ...
                    <Link to="/jobs"><button  className='bg-violet-400 text-white px-3 rounded-md w-1/2 text-center p-2 font-bold	mx-auto'>Apply Now</button></Link>
                </div>
            </section>
